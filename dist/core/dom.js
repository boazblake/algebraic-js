...
export const writeHtml = (selector, html) => withElement(selector, el => { if (el)
    el.innerHTML = html; return el; });
export const appendHtml = (selector, html) => withElement(selector, el => { if (el)
    el.insertAdjacentHTML("beforeend", html); return el; });
export const writeText = (selector, text) => withElement(selector, el => { if (el)
