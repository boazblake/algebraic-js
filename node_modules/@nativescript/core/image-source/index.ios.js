...
export class ImageSource {
    ...
    static iosSystemScaleFor(scale) {
        switch (scale) {
            case 'small':
                return 1 /* UIImageSymbolScale.Small */;
            case 'medium':
                return 2 /* UIImageSymbolScale.Medium */;
            case 'large':
                return 3 /* UIImageSymbolScale.Large */;
            default:
                return -1 /* UIImageSymbolScale.Default */;
        }
    }
    static fromSystemImageSync(name, instance) {
    ...
    static fromSystemImage(name, instance) {
        return new Promise((resolve, reject) => {
            try {
                let image;
                if (instance?.iosSymbolScale) {
    ...
    static systemImageWithConfig(name, instance) {
        const fontSize = instance.style.fontSize;
        const fontWeight = instance.style.fontWeight;
        return UIImage.systemImageNamedWithConfiguration(name, fontSize ? UIImageSymbolConfiguration.configurationWithPointSizeWeightScale(fontSize, fontWeight === 'bold' ? 7 /* UIImageSymbolWeight.Bold */ : 4 /* UIImageSymbolWeight.Regular */, ImageSource.iosSystemScaleFor(instance.iosSymbolScale)) : UIImageSymbolConfiguration.configurationWithScale(ImageSource.iosSystemScaleFor(instance.iosSymbolScale)));
    }
