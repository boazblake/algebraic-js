...
export declare namespace ios {
    type LayerMaskType = 'BORDER' | 'CLIP_PATH';
    namespace LayerMask {
        const BORDER = "BORDER";
    ...
    function drawGradient(nativeView: UIView, gradientLayer: CAGradientLayer, gradient: LinearGradient, gradientLayerOpacity?: number): void;
}
