...
export class ActionBar extends ActionBarBase {
    ...
    checkLargeTitleSupport(navigationItem) {
        const navBar = this.navBar;
        if (!navBar) {
            return;
        }
        ...
        if (SDK_VERSION >= 11) {
            if (this.iosLargeTitle) {
                ...
                navigationItem.largeTitleDisplayMode = 1 /* UINavigationItemLargeTitleDisplayMode.Always */;
            }
            else {
                if (SDK_VERSION >= 26) {
                    // Explicitly disable large titles for this navigation item
                    // Due to overlapping title issue in iOS 26
                    navigationItem.largeTitleDisplayMode = 2 /* UINavigationItemLargeTitleDisplayMode.Never */;
                }
                else {
                    navigationItem.largeTitleDisplayMode = 0 /* UINavigationItemLargeTitleDisplayMode.Automatic */;
                }
            }
        }
    }
